...
import 'package:test_project_abc/injector.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<UsersBlocBloc>(
      create: (context) => sl<UsersBlocBloc>()..add(const GetUsers()),
      child: MaterialApp(
        title: 'Flutter Demo',
        theme: ThemeData(
    ...
    return Scaffold(
      ...
      body: BlocBuilder<UsersBlocBloc, UsersBlocState>(
        builder: (context, state) {
          ...
          } else if (state is FailedUsers) {
            return Text(state.error);
          } else if (state is SuccessUsers) {
